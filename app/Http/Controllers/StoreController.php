...
class StoreController extends Controller
{
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'latitude.required' => 'Titik lokasi warung wajib diisi — klik peta atau tekan “Gunakan lokasi saya”.',
            'longitude.required' => 'Titik lokasi warung wajib diisi — klik peta atau tekan “Gunakan lokasi saya”.',
