...
<section class="pt-24 sm:pt-28 pb-14 max-w-4xl mx-auto px-4 sm:px-6">
    ...
    <div class="mt-6 grid gap-3">
        @foreach([
            ...
            ['06', 'Keamanan', 'Kata sandi di-hash (bcrypt), trafik dienkripsi (HTTPS), akses internal dibatasi peran, dan sesi kedaluwarsa otomatis. Tidak ada sistem yang 100% kebal — jika menemukan celah, laporkan ke halo@warunghebat.id dan kami menindaklanjuti maksimal 3×24 jam.'],
            ...
            ['10', 'Perubahan & kontak', 'Kebijakan ini dapat diperbarui; versi terbaru selalu ada di halaman ini dengan tanggal revisi. Pertanyaan privasi? Email: halo@warunghebat.id dengan subjek “Privasi”, atau gunakan halaman Hubungi Kami.'],
        ] as $i => $s)
