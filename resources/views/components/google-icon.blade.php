{{-- Google "G" mark. Multi-colour, so it can't use the single-colour icon component. --}}
<svg {{ $attributes->merge(['class' => 'w-5 h-5 shrink-0']) }} viewBox="0 0 24 24" aria-hidden="true">
