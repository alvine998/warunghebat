...
<div class="min-h-screen lg:grid lg:grid-cols-[260px_1fr]">
    ...
    <aside class="bg-ink-900 text-white lg:h-screen lg:overflow-y-auto lg:sticky lg:top-0 flex lg:flex-col">
        ...
        <nav class="hidden lg:grid gap-1 px-4 text-[13px] font-bold">
            ...
            <a href="{{ route('admin.articles') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-2xl {{ request()->routeIs('admin.articles*') ? 'bg-white text-ink-900' : 'hover:bg-white/10 text-white/80' }}"><x-icon name="document" class="w-5 h-5" /> Artikel</a>
            ...
            <a href="{{ route('admin.inquiries') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-2xl {{ request()->routeIs('admin.inquiries*') ? 'bg-white text-ink-900' : 'hover:bg-white/10 text-white/80' }}"><x-icon name="chat" class="w-5 h-5" /> Pesan Masuk</a>
    ...
    <div class="lg:hidden bg-ink-900 text-white px-4 pb-4 -mt-1">
        <nav class="flex gap-1.5 overflow-x-auto text-[12px] font-extrabold pb-1">
            ...
            <a href="{{ route('admin.articles') }}" class="shrink-0 flex flex-col items-center gap-1 text-center py-2.5 px-3.5 rounded-xl {{ request()->routeIs('admin.articles*') ? 'bg-white text-ink-900' : 'bg-white/10' }}"><x-icon name="document" class="w-5 h-5" /> Artikel</a>
            ...
            <a href="{{ route('admin.inquiries') }}" class="shrink-0 flex flex-col items-center gap-1 text-center py-2.5 px-3.5 rounded-xl {{ request()->routeIs('admin.inquiries*') ? 'bg-white text-ink-900' : 'bg-white/10' }}"><x-icon name="chat" class="w-5 h-5" /> Pesan</a>
